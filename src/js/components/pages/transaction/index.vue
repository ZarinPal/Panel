    ...
    div.inner-content
        ...
        div.row.nav-page-header
            ...
            div.col-lg-6.col-md-6.col-sm-12.col-xs-12
                ...
                router-link.btn.success.pull-left(tag="button" v-bind:to="{ name: 'report.index', params: {reportFor: 'purse', reportId: this.$route.params.id}} ") {{ $i18n.t('tran.returnToDashboard') }}
