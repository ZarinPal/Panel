                ...
                div.row.box
                    ...
                    div.right-box.col-lg-6.col-md-6.col-sm-12.col-xs-12
                        ...
                        div.row
                            ...
                            div.col-lg-8.col-md-8.col-sm-12.col-xs-12
                                input.ltr-input(:class="{'input-danger': validationErrors.expired_at}" v-mask="{type: 'date'}" v-validate="{type: 'number'}" maxlength="10" type="text" v-model="expired_at" placeholder="1398-09-21" tabindex="4")
