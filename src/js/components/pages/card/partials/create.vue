              ...
              div.row.nav-expiration-input
                ...
                div.col-xs.no-margin
                  div
                    ...
                    input#year(v-validate="{ rules: {required: true, numeric: true, min_value : 1396 , max_value: this.nextSixYears}}" v-bind:data-vv-as="$i18n.t('card.year')" :class="{'input-danger': errors.has('year')}" maxlength="4" type="text" v-model="year" name="year" :placeholder="$i18n.t('card.year')")
