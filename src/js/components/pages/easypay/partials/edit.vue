                        ...
                        div.col-lg-7.col-md-7.col-sm-12.col-xs-12
                            ...
                            div.row
                                ...
                                div.col-lg-11.col-md-11.sm-11.col-xs-11
                                    ...
                                    selectbox.selectbox.col-lg-12.col-md-12.col-sm-12.col-xs-12(v-on:select="selectedPurse" v-bind:data="pursesSelection" v-bind:selected="easypay.purse" placeholder="کیف پول متصل")
