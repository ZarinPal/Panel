                                ...
                                div.row
                                    ...
                                    div.col-lg-11.col-md-11.sm-11.col-xs-11
                                        ...
                                        div.row.no-margin
                                            ...
                                            input.ltr-input(v-validate="{type: 'number', money: true}" maxlength="15" :class="{'input-danger': validationErrors.price}"  type="text" v-model="price" placeholder= "(مبلغ (تومان")
