                    ...
                    div.row.f-row
                      ...
                      div.nav-optional-radios.col-lg-9.col-md-9.col-sm-9.col-xs-12(v-if="requiredFields.name.checkbox")
                        div.row
                          ...
                          div.col-lg-4.col-md-4.col-sm-12.col-xs-12
                            input(name="usernamePlaceholder" id="mobilePlaceholder" v-model="usernamePlaceholder" v-bind:data-vv-as="$i18n.t('webservice.description')" v-validate="'max:40'" :class="{'input-danger': errors.has('usernamePlaceholder')}"  type="text" :placeholder="$i18n.t('easypay.descriptionInHere')" )
