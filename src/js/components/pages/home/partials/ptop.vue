                    ...
                    form(autocomplete="on" onsubmit="event.preventDefault();")
                        div.row
                            ...
                            div.col-xs.no-right-margin
                                input.ltr-input(v-validate="{type: 'number', money: true}" maxlength="15" :class="{'input-danger': validationErrors.amount}" inputmode="numeric" type="text" v-model="amount" placeholder="مبلغ"  tabindex="1")
